<template>
  <div class="receipt-payment">
    <search-bar :select-list="selectList" :search="search" :btn-list="btnList" @changeSearch="changeSearch">
      <div slot="searchBar8" class="external-list">
        <span>项目归属</span>
        <el-select
    ...
    <div class="from-box">
      <el-form ref="ruleForm" :key="key" :model="ruleForm" label-width="160px" class="rule-form-flex el-form-item">
        ...
        <el-form-item label="发票付款金额合计">
          <el-input
            v-model.trim="formInline.user4"
            disabled
          />
        </el-form-item>
        <el-form-item label="发票付款余额合计">
          <el-input
...
<script>
import searchTableData from '../searchTableData/receiptPayment'
