  ...
  <div class="joint-project">
    <div>
      ...
      >
        ...
        <el-table-column prop="number" label="工程名称" align="center" width="320">
          <template slot-scope="scope">
            <div class="table-click-color" @click="updateData('details',scope.row)">{{ scope.row.number }}</div>
          </template>
        </el-table-column>
        <el-table-column prop="number" label="项目经理" align="center" />
        <el-table-column prop="number" label="签订日期" align="center" />
        <el-table-column prop="number" label="开工日期" align="center" />
        <el-table-column prop="number" label="竣工日期" align="center" />
        <el-table-column prop="number" label="工程状态" align="center" />
      </el-table>
    </div>
