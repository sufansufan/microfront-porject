  ...
  <div class="verification-application">
    ...
    <div>
      <el-table :data="tableData" row-key="id" border default-expand-all>
        ...
        <el-table-column prop="loannumber" label="申请单号" sortable width="180" align="center">
          <template slot-scope="scope">
            <div class="table-click-color" @click="addClick('detail')">{{ scope.row.loannumber }}</div>
          </template>
        </el-table-column>
        <el-table-column prop="borrower" align="center" sortable label="申请人" />
        <el-table-column prop="organization" label="申请部门" sortable align="center" />
        <el-table-column prop="loanamount" label="联系电话" align="center" />
        <el-table-column prop="amountpaid" label="事由" align="center" />
        <el-table-column prop="unpaidamount" label="申请时间" sortable align="center" />
        ...
        <el-table-column prop="borrowers" label="审批结果" align="center" width="180" /></el-table>
    </div>
    ...
    <drag-dialog ref="dialog" title="审批步骤" width="50%">
