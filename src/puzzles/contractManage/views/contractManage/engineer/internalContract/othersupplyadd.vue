<template>
  <div class="other-supply-add">
    ...
    <el-form ref="ruleForm" :key="key" v-loading="loading" :rules="rules" :model="ruleForm" label-width="100px" class="other-supply-form">
  ...
  data() {
    ...
    return {
      ...
      ruleForm: {
        ...
        state: '', // 协议状态
        filingDate: '', // 归档日期
        signUnitName: getSessionStorage('constructionUnit'), // 签订单位
