...
<script>
import InvoiceDetails from './components/simpleTaxation/invoiceDetails'
import ReceiptsDetails from './components/simpleTaxation/receiptsDetails'
import TicketCollectionDetails from './components/simpleTaxation/ticketCollectionDetails'
import CertificationDetails from './components/simpleTaxation/certificationDetails'
import TransferOfEntries from './components/simpleTaxation/transferOfEntries'
import ExportDeduction from './components/simpleTaxation/exportDeduction'
export default {
