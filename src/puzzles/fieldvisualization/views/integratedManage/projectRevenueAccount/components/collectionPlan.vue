  ...
  <div class="collection-Plan">
    ...
    <div>
      <el-table :data="tableData" row-key="id" border default-expand-all>
        ...
        <el-table-column prop="name" label="计划划款日期" align="center" />
        <el-table-column prop="name" label="计划收款事项" align="center" />
        <el-table-column prop="name" label="付款比例" align="center" />
        <el-table-column prop="name" label="计划收款金额" align="right" header-align="center" />
