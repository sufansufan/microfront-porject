  ...
  <div class="payment-details">
    ...
    <div>
      <el-table :data="tableData" row-key="id" border default-expand-all>
        ...
        <el-table-column prop="name" label="付款日期" align="center" />
        <el-table-column prop="name" label="付款方式" align="center" />
        <el-table-column prop="name" label="付款金额" align="center" />
        <el-table-column prop="id" label="支票号" align="center" header-align="center" />
        <el-table-column prop="name" label="是否保证金" align="center" />
        <el-table-column prop="name" label="领款人" align="center" />
