  ...
  <div class="guarantee-deposit">
    ...
    <div>
      <el-table :data="tableData" row-key="id" border default-expand-all>
        ...
        <el-table-column prop="name" label="操作日期" align="center" />
        <el-table-column prop="name" label="操作类型" align="center" />
        <el-table-column prop="name" label="金额" align="right" header-align="center" />
        <el-table-column prop="id" label="付款方式" align="center" header-align="center" />
    ...
    <div>
      <el-form :rules="rules" :model="ruleform" label-width="100px" class="dictionary-smal">
        <el-form-item label="甲方质保金">
          <el-input v-model="ruleform.read" placeholder="请输入" disabled="true" />
        </el-form-item>
        <el-form-item label="项目质保金">
          <el-input v-model="ruleform.read" placeholder="请输入" disabled="true" />
        </el-form-item>
        <el-form-item label="银行保函金">
          <el-input v-model="ruleform.read" placeholder="请输入" disabled="true" />
        </el-form-item>
        <el-form-item label="甲方押金">
          <el-input v-model="ruleform.read" placeholder="请输入" disabled="true" />
        </el-form-item>
        <el-form-item label="项目押金">
